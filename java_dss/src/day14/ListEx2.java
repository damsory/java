...
public class ListEx2 {
	...
	public static void main(String[] args) {
		//정수를 5개 입력받아 입력받은 정수를 리스트에 저장하는, 출력하는 코드를 작성하세요.
	...
	//콘솔창에서 입력받아야 하기 때문에 표준 입력인 System.in 인스턴스 전달
	Scanner scan=new Scanner(System.in);
	//입력받을 정수의 개수
	int count =5;
	//System에 있는 out 인스턴스에서 제공하는 print매서드를 이용하여 콘솔창에 문자열을 출력 
	...
	for(int i=0;i<count;i++) {
		...
		//Collection에서 제공하는 add 매서드를 이용하여 리스트에 정수값을 추가
