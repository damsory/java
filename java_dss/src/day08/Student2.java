...
public class Student2 {
	//맴버변수 :국어성적,수학성적,영어성적, 학생번호,학년,반,이름
	int kor,eng,math;
	int grade,classNum,num;
	String name;	
	
	//매서드 :학생 정보 확인 ,학생 성적 확인, 국어성적 수정,수학성적 수정,영어성적 수정
	/*기능 : 학생정보(학년,반,번호,이름)을 콘솔에 출력하는 메서드
	 * 매개변수:없음
	 * 리턴타입:없음 void
	 * 매서드명:printInfo
	 * */
	...
	/*기능 : 국어 성적을 수정하는 메서드
	 * 매개변수 :수정 하려는 국어 성적 => int korScore
	 * 리턴타입 :없음 void
	 * 매서드명 : setKor
	  */
